...
class Home extends Component{
    ...
    constructor(){
        ...
        UNSAFE_componentWillMount() {
            ...
            xhrEndPt1.open("GET", this.props.baseUrl+"me/media?fields=id,caption&access_token=IGQVJWa3c0RnRrX3BLMEJDV09ycENHWE82WHRaRGhpNHZAIdkVodGVLdV9heDlMRHFKc2k3UzVVcXJzYmJNbHctUHJjSXhmd3NSYmdIUTZAKZAzRXejZAQdndZAaE9yQlFxak5aSHNaT1c4YThnRS0wVnJJQ2xwVV9nUGZA0MkNB");
            xhrEndPt1.send(null);
            ...
            xhrEndPt2.open("GET",this.props.baseUrl+"17867082200156074?fields=id,media_type,media_url,username,timestamp&access_token=IGQVJWa3c0RnRrX3BLMEJDV09ycENHWE82WHRaRGhpNHZAIdkVodGVLdV9heDlMRHFKc2k3UzVVcXJzYmJNbHctUHJjSXhmd3NSYmdIUTZAKZAzRXejZAQdndZAaE9yQlFxak5aSHNaT1c4YThnRS0wVnJJQ2xwVV9nUGZA0MkNB");
            xhrEndPt2.send(null);
                ...
                <div>             
                    ...
                    {this.state.userImages.map(img =>(
                        <Card className={classes.card} key={"card"+img.id}>
                            <CardHeader avatar={
                             <Avatar alt="profile-Pic" src={(this.state.media_url).toString()} className={classes.avatar}/>
                            }    
