...
//constructor definitions for state variables declarations
    ...
    loginButtonHandler = () => {
        ...
        if (this.state.username === usernameCorrect && this.state.password === passwordCorrect) {
            sessionStorage.setItem('access_token', 'IGQVJYNlBVOW03d3RIeXJKeUh1TnJpdFBMQWtKbk1oQ0lEX3FkZAnFGbTdYQmEweTFjOTVHV3hoZAU1yMER6NGY1eWRvRU53V2RHbE1yM3FIellESDJHdEVZAVlZAyRHloSmVjdFVxbTg4ay1jZAGVxSVBfdEZAqeFpJcUhUUktZA');
